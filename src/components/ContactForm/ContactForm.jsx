        ...
        if (isFormValid){
            ...
            try {
                const response = await fetch('https://api.web3forms.com/submit', {
                    ...
                    body: JSON.stringify({...formData, access_key: "a58c2333-66aa-4503-8735-316e1f4418f5"})
                })
        ...
        <div className="contact-form d-flex fd-column al-center">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className=" al-center d-flex jc-end form-group">
                    {formSubmitted && <p className="primary">{appContext.languages[appContext.language].contact.sucessMsg}</p>}
                    <div>
